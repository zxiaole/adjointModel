...
* [luc-glcf.cpp](src/modifiedPolyphemus/polair3dAjoint/luc-glcf.cpp): modified the bugs in the original code when preprocessing the land use data due to the exceeding   the limits of the input file.
