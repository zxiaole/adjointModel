...
int main(int argc, char** argv)
{
    ...
    // 20230507 Xiaole to solve the misalignment of the data
    RegularGrid<real> GridT_in_fc(t_min_in-5.5, Delta_t_in, Nt_in+12);
    ...
    Data<real, 3> SolarRadiation(GridT_in_fc, GridY_in, GridX_in);
    Data<real, 3> SolarRadiation_prev(GridT_in_fc, GridY_in, GridX_in);
    ...
    Data<real, 3> U_star(GridT_in_fc, GridY_in, GridX_in);
    Data<real, 3> V_star(GridT_in_fc, GridY_in, GridX_in);
    Data<real, 3> U_star_prev(GridT_in_fc, GridY_in, GridX_in);
    Data<real, 3> V_star_prev(GridT_in_fc, GridY_in, GridX_in);
    Data<real, 3> SoilWater(GridT_in, GridY_in, GridX_in);
    Data<real, 3> SensibleHeat(GridT_in_fc, GridY_in, GridX_in);
    Data<real, 3> SensibleHeat_prev(GridT_in_fc, GridY_in, GridX_in);
    Data<real, 3> Evaporation(GridT_in_fc, GridY_in, GridX_in);
    Data<real, 3> Evaporation_prev(GridT_in_fc, GridY_in, GridX_in);
    Data<real, 3> ConvectiveRain(GridT_in_fc, GridY_in, GridX_in);
    Data<real, 3> ConvectiveRain_prev(GridT_in_fc, GridY_in, GridX_in);
    Data<real, 3> LargeScaleRain(GridT_in_fc, GridY_in, GridX_in);
    Data<real, 3> LargeScaleRain_prev(GridT_in_fc, GridY_in, GridX_in);
    ...
    InputMeteo.Read(file_in, 134, SurfacePressure);
    ...
    FormatFormattedText InputCoefficients("<e><e>");
    cout<<directory_in + "hybrid_coefficients.dat";
    InputCoefficients.Read(directory_in + "hybrid_coefficients.dat",
                           "0", alpha);

    InputCoefficients.Read(directory_in + "hybrid_coefficients.dat", "1", beta);
