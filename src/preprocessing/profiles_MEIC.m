...
x_min = configs.x_min;
Delta_x = configs.Delta_x;
Nx = configs.Nx;

y_min = configs.y_min;
Delta_y = configs.Delta_y;
Ny = configs.Ny;
...
initialTime = datetime(configs.Date_min,'InputFormat',inputFormat);
...
totalHours = configs.Delta_t*configs.Nt/3600;
...
for sectorName = sectors
    ...
    [rawData, configs, configs2] = importdata(fileName,' ',6);
